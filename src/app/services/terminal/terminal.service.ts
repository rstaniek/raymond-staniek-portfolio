...
export class TerminalService {
  ...
  public parseCommand(args: string[]): string[] {
    ...
    if(args === undefined || args.length === 0){
      ...
      switch(reversed.pop()){
        ...
        case 'hello':
          return this.printHello(reversed);
        case 'skills':
          return this.printSkills(reversed);
        default:
          return ['Could not recognize any command! Type "help" for a list of available commands'];
      }
    }
  }
